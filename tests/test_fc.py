...
@patch("paradrop.chute.executionplan.abortPlans", return_value=True)
@patch("paradrop.chute.executionplan.executePlans", return_value=True)
def test_update_object(executePlans, abortPlans):
    """
    Test the UpdateObject class
    """
    from paradrop.chute.updateObject import UpdateObject
...
def test_update_object_parse():
    ...
    """
    from paradrop.chute.updateObject import UpdateChute, parse
